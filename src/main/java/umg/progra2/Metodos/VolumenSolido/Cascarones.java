...
public class Cascarones {
    ...
    public double calcularVolumen(UnivariateFunction function, double a, double b, char variable){
        SimpsonIntegrator integrator = new SimpsonIntegrator();
        return 2 * Math.PI * integrator.integrate(10000, (v) -> v * function.value(v), a, b);
    }


    public UnivariateFunction crearFuncion(String input, char variable) {
